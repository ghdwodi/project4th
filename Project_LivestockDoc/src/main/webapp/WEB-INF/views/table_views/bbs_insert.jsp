	...
	<head>
		...
		<script type="text/javascript">
			function bbs_insert(f) {
				...
				$.ajax({
					url:"Rest/bbs_insert.do",
					type:"get",
					data:$("#bbsinsertform").serialize(),	// 서블릿에 넘어가는 데이터
					dataType:"text",
							...
							<div class="container-fluid">
								<form id="bbsinsertform">
									<table class="table">
										...
										<tr>
											<td colspan="2">
												<input type="button" value="입력" class="btn btn-default" onclick="bbs_insert(this.form)"/>
												<input type="button" value="목록" class="btn btn-default" onclick="javascript:location.href='bbs.go?b_category=${b_category}'"/>
											</td>
										</tr>
									</table>
								</form>
